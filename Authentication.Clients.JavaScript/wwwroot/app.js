...
//var config = {
//    authority: "http://localhost:55400/",
//    //client_id: "3406cc01-d2cb-45d7-a0b6-48e9e046a426",
//    //client_id: "implicit-js-oidc",
//    client_id: '4fa1021f-6ded-413d-9152-f3b23abdc0fa',
...
var config = {
   ...
   // popupWindowFeatures: "menubar=yes,location=yes,toolbar=yes,width=1200,height=800,left=100,top=100;resizable=yes",
    ...
    // needed if you want to use the silent_renew
    response_type: "id_token token",
    scope: "openid profile api.resource.read api.resource.write",
...
function login(scope, responseType) {
    console.log("Logging in with scopes " + scope + " and response_type " + responseType);
    console.log(mgr);
    mgr.signinRedirect({ scope: scope, response_type: responseType });
}
...
function callApi() {
    mgr.getUser().then(function (user) {
        //display("#user-info", JSON.stringify(user, null, 2));
        ...
        xhr.open("GET", "http://localhost:5001/identity", true);
